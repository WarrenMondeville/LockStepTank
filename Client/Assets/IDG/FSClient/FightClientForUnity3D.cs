...
/*         InputCenter.SetKey(Input.GetKey(KeyCode.A),KeyNum.Left);
         InputCenter.SetKey(Input.GetKey(KeyCode.D),KeyNum.Right);
         InputCenter.SetKey(Input.GetKey(KeyCode.W),KeyNum.Up);
         InputCenter.SetKey(Input.GetKey(KeyCode.S),KeyNum.Down);*/
